...
<div class="card">
  ...
  <div class="row">
    ...
    <div class="col">
      <input type="text" class="form-control" name="totalbalance" placeholder="Total Amount">
    </div>
  ...
  <option value="Dr">Dr</option>
    ...
    <div class="col">
      <input type="text" class="form-control" name="debtor_first_name" placeholder="Debtor First">
    </div>
    <div class="col">
      <input type="text" class="form-control" name="debtor_surname" placeholder="Debtor Surname">
    </div>
    <div class="col">
    ...
    <div class="col">
      <input type="text" class="form-control" name="lastpaymentdate" placeholder="Last Payment Date">
    </div>
    <div class="col">
      <input type="text" class="form-control" name="lastamount" placeholder="Last Payment Amount">
    </div>
  </div> </br>
  ...
  <div class="row">
        <div class="col">
      <input type="text" class="form-control" name="empcontacts"  placeholder="Employee Contacts">
    </div>
  ...
  <div class="row">
  <div class="col">
      <input type="text" class="form-control" name="interest_rate" placeholder="Total Interest">
    </div>
